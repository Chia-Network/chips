...
This CHIP presents a standardized VC metadata structure that conforms to the VC1 standard. It contains an off-chain metadata format, which VCs can reference. Note that this standard does not describe any specific proof values. Instead, they will be standardized in additional CHIPs, starting with the KYC VC Structure CHIP.
