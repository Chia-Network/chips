...
On the flip side, single sided offers are actually already secure, since the taker can assert their own payments end up in the right place. It's not important that the original offer be private since it's just requesting assets. Therefore, signature subtraction is not a risk either.
