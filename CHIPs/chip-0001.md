...
Description: A living document to outline the CHIP process, from _Idea_ to _Final_.
...
If there is general consensus during this phase, a CHIP Editor (and not the author) will move the proposal into the next phase.
