...
This CHIP requires a soft fork of Chia's blockchain. The fork will activate at block `4 603 536`.
...
Because of its forward incompatibility, this CHIP will require a soft fork of Chia's blockchain. This fork will activate at block `4 603 536`.
...
|------------------: | ------------------: | ----------: | ---------: |
| Before `4 603 536` | Before Dec 2023     | 512         |       0.00 |
|   `4 603 536`      | Dec 2023            | 512         |       0.58 |
...
* [15885](https://github.com/Chia-Network/chia-blockchain/pull/15885) - SOFT_FORK4_HEIGHT
