...
This CHIP requires a soft fork of Chia's blockchain. The fork will activate at a block height to be determined later.
...
Because of its forward incompatibility, this CHIP will require a soft fork of Chia's blockchain. This fork will activate at a block height to be determined later.
...
|------------------: | ------------------: | ----------: | ---------: |
| Before fork height | TBD                 | 512         |       0.00 |
| Fork height        | TBD                 | 512         |       0.58 |
