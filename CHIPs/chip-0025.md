...
This CHIP introduces two new message conditions that will make it more difficult to create inadvertently insecure spends of the types mentioned here. These new conditions will require a soft fork, which will occur at block `5 550 000` (five million, five hundred and fifty thousand).
...
The fork height was set in [PR #17772](https://github.com/Chia-Network/chia-blockchain/pull/17772) of the [chia-blockchain repository](https://github.com/Chia-Network/chia-blockchain).
