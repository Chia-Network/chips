...
Functionality: Creates a `message` using the specified `mode`

Usage: `(CREATE_MESSAGE_FOR_COIN mode message)`
...
Functionality: Asserts the `message` using the specified `mode`

Usage: `(ASSERT_MESSAGE_FROM_COIN mode message)`
