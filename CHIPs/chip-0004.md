...
* DIDs should not contain any personally identifiable information. This includes both on-chain and off-chain data
...
* Offers
  * DID owners may include their credentials when acting as the Maker in an offer of XCH, Chia Asset Tokens (CATs), Non-Fungible Tokens (NFTs) or any other Chia asset
