...
## Specification
The action layer can be found [here](https://github.com/Yakuhito/slot-machine/blob/9f38fb24738986fc097d963dafb811fee7e20cfd/rue-puzzles/singleton/action.rue). The default finalizer can be found [here](https://github.com/Yakuhito/slot-machine/blob/9f38fb24738986fc097d963dafb811fee7e20cfd/rue-puzzles/singleton/finalizer.rue), and the reserve finalizer can be found [here](https://github.com/Yakuhito/slot-machine/blob/9f38fb24738986fc097d963dafb811fee7e20cfd/rue-puzzles/singleton/reserve_finalizer.rue). The slot puzzle can be found [here](https://github.com/Yakuhito/slot-machine/blob/9f38fb24738986fc097d963dafb811fee7e20cfd/rue-puzzles/singleton/slot.rue). More documentation about the action layer and slots can be found [here](https://docs.catalog.cat/technical-manual/action-layer) and [here](https://docs.catalog.cat/technical-manual/slots).
