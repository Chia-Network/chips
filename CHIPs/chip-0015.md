...
## Reference Implementation
  ...
  * Note - examples are non-exhaustive of the possibilities from schema.org integrations.
  * Note - some examples expand on the CHIP-0007 example to update the "format" and "data" objects.
