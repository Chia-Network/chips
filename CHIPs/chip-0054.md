...
| **Self-Attestation Bias** | Peers ignore selection rules and only vote for blocks they proposed. | Only attestations to the winning block earn rewards. Since all honest peers use the same deterministic selection, rational actors follow the protocol, and rogue attestations are economically worthless. |
