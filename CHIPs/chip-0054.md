...
At launch, handles will be owned and resolved to NFTs with the [any_metadata](https://github.com/Yakuhito/slot-machine/blob/de863376d921b2d0fe9fcddb8c860f52e1958a30/puzzles/nft/any_metadata.clsp) puzzle. This will allow the NFTs’ owners to update all fields of the metadata as desired. A resolver compatible with this specification will be able to resolve the following fields:
...
The premine - handles that have been pre-registered before launch - is available [here](https://github.com/Yakuhito/nfts/blob/86e3c02512f71ca46179e50cd2bbf095c15236be/premine.csv) and explained [here](https://docs.xchandles.com/premine).
...
Special thanks to Rigidity, stl, and Andreas for providing feedback on early designs of the dApp. Many thanks to BramV and Rigidity for reviewing the second to last, as well as the final version of the dApps in Chialisp and/or Rue.