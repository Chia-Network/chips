...
Author        | [Quexington](https://github.com/Quexington)
Editor        | [Dan Perry](https://github.com/danieljperry)
Comments-URI  | [CHIPs repo, PR #203](https://github.com/Chia-Network/chips/pull/203)
Status        | Draft
Category      | Standards Track
Sub-Category  | Primitive
Created       | 2026-05-22
Requires      | [CHIP-0043](https://github.com/Chia-Network/chips/blob/main/CHIPs/chip-0043.md)
...
* The only change to a partial will be in the `ProofOfSpace` object. It will contain the additional fields `plot_index`, `version`, `meta_group`, and `strength`.
...
* The `ProofOfSpace` object in a partial will contain extra fields that will be set with non-zero values for v2 plots. Any differences in verifying these partials is out of scope of this CHIP.
...
[Puzzle Diagram](https://github.com/Chia-Network/chips/blob/quex.pooling_v2/assets/chip-0059/Pooling%20V2%20Chialisp.png)
